...
public class FootballMatch {
    ...
    public int matchResult(int result1, int result2, int bet1, int bet2) {
        return ((result1 == bet1) && (result2 == bet2)) ? 2 : /* 100% gues*/
                ((result1 > result2) && (bet1 > bet2)) ? 1 :    /* first team won*/
                ((result1 < result2) && (bet1 < bet2)) ? 1 :      /* second team won*/
                    ((result1 == result2) && (bet1 == bet2)) ? 1 : 0; /* second team won*/
    }
}
